...
# round-robin (doctrine 7+8).  Usage: eipb_p33_run.sh [sessions]
set -u
REPO=/mnt/c/Users/14977/source/repos/emacs
CORE=$REPO/bench/eipb/phase3/eipb_p33_core.el
LOG=${EIPB_P33_LOG:-$REPO/bench/results/eipb_t33.log}
ROUNDS=${1:-2}
: > "$LOG"
echo "EIPB3_P33_BEGIN|$(date +%s)|sessions=$ROUNDS|order=randomized" >> "$LOG"
...
echo "EIPB3_P33_DONE|$(date +%s)" >> "$LOG"
