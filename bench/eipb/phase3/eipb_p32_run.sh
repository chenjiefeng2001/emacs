...
# round-robin (doctrine 7+8).  Usage: eipb_p32_run.sh [sessions]
set -u
REPO=/mnt/c/Users/14977/source/repos/emacs
CORE=$REPO/bench/eipb/phase3/eipb_p32_core.el
LOG=${EIPB_P32_LOG:-$REPO/bench/results/eipb_t32.log}
ROUNDS=${1:-2}
: > "$LOG"
echo "EIPB3_P32_BEGIN|$(date +%s)|sessions=$ROUNDS|order=randomized" >> "$LOG"
...
echo "EIPB3_P32_DONE|$(date +%s)" >> "$LOG"
