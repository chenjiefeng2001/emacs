...
## 19. EVS-3 Closure �� Main-thread Wakeup:���� 20ms �����ذ�(2026-08-24)

### 19.1 ʵ��(EVS-3.0,��Լ����:`bench/enca/evs3/EVS3.md`)
- `enca/wake/wake.{h,c}`:Runtime Notification ԭ��(token + mutex + condvar ���ϸ�Э��;IDLE/NOTIFIED/MAIN_DRAINING ���塢coalescing��produce-then-notify / drain-then-wait �����붪����֤��д����Լ);
- scheduler ���ӿ�ѡҵ����֪ observer(`result_notify`,Ҷ�Ӱ�ȫԼ��),�ڽ����Ӻ󴥷�����scheduler ��֪�� Emacs;
- **EVS-3 �Ž�ץ������ȱ��**:�ĵ����Ƶ� STOP_ACCEPTING �ύ�Ŵ�δʵ��(`shutdown_rejects` ���������ڵ����˵���,shutdown ���ύ�ᾲĬ���)�� ���� lifecycle ���,wake/shutdown �׼�����;
- ���׼�:single/burst/drain-race/notify-during-drain/producer-storm/shutdown/generation-reset��**24318/0 ��3 native + ASan clean + TSan(WSL gcc)0 warnings**����˳������ EVS-2 ������ TSan ֤��(ȫ������)��

### 19.2 EVS-3.1 ����(��ʵ Emacs ����,ͬ A/B harness)
| ���� | �ذ��� p50 | wakeup �� p50 |
|---|---|---|
...
| E4 100MB | ~452�C485ms | ~386�C624ms(��������) |

~20ms �ذ� �� ΢�뼶���ذ��Ƴ����״ι�ƽ�ؿ�������ɱ�:10MB ���������ȶ��� ~20%(40 vs 55ms);100MB ���ϳ�ȫ�ķ���(~400ms+)����,˫�۴�ƽ������ EVS-2 NO-GO ����һ�¡�

### 19.3 �ж�
- EVS-3 = **�ɹ�**:Ŀ����ǵذ屾��,keypress��commit ��С�ĵ��ﵽ΢�뼶;
- EVS-2 NO-GO ά�ֲ���(��18),�ܹ��������д�� `src/enca/ARCHITECTURE.md` ��25;
- ��һ�������ɱ��ѿɲ���:**���ĵ�����"ÿ revision ȫ�ĵ�����"�Ĺ�������ģ��**���������� Real Completion(������������)�Ķ���֤��;GUI Redisplay ��֧�Դ� GUI �Ự���ݡ�



## 20. EVS-4.1/4.2 �� Synthetic Completion Slice(2026-08-24)

### 20.1 ��Լ����(`bench/enca/evs4/COMPLETION.md`)
Completion ����**������ĵ�**:ֻ�� snapshot ���� + ������ context range,��**����** `enca_snapshot_walk_text` ��ȡ�������� Snapshot API��W1�CW4(ǰ׺/��Ա/ʵ��/�﷨)���� 32B�C4KB ����;C1�CC4 = 64KB/1MB/10MB/100MB;simd-json��tree-sitter��Range View ȫ����ʽ���硣

### 20.2 O(region) Ԥ���Ž�(CONTRACT ��8)
| �ĵ���С | 256B ������ȡ avg | piece �� |
|---|---|---|
| 1MB | 1.46��s | 801 |
| 8MB | 2.75��s | 801 |
| 10MB | 2.66��s | 801 |
...
�ĵ� ��100 ����,��ȡ�ɱ��㶨΢�뼶(�������� ~800 Ƭ�ε�Ԫ����ɨ��)��**Range View ��������������֧��**:�����ȡ���κοɸ�֪�ӳٲ� 4 ����������
...
����:(a) ����������籩�� drop-before-compute ����(1/12 ִ��);(b) �ϳ� server ̫��ʱ����������ѹ����supersession ���¿�����**��**��Ϣ;(c) ������ʵ����ӳٺ�,�Ŷ����� REPLACE ����,��**ִ����������Ӱ��**(2ms �� 9/12)���������� #23 �ı߽�:in-flight ������Э��ȡ��(EVS-4.3 ����ʵ LSP ʱ����)��

### 20.4 ��ȷ������֤
- ct/extract-oracle:ͬһ���ݾ� flat �� piece-backed ���ִ洢,21 �����������һ�뾵�� buffer �ֽڱȶ�ȫ��;
- ct/basic / o-region-budget / storm;ȫ�׼� **31750 checks / 0 failures** native,ASan clean,**TSan(WSL gcc)0 warnings / 31747 / 0**��

### 20.5 ��һ��
EVS-4.3(��Ŀ�� clangd)��ǰ������������:synthetic ��Ƭ֤�� workload ��״������admission �� IDE �͸�������Ϊ��ȷ�������ȡ�ɱ��ɺ��ԡ�ʣ�����ȫ�������� 4.3/4.4 �Ĵ������ Completion UI/redisplay ����



## 21. EVS-4.3 Closure �� Real LSP Transport Attribution(2026-08-24,clangd 19.1.0)

### 21.1 ��Լ��ʵ��(`bench/enca/evs4/EVS43.md`)
Scheduler ����ҵ����֪����LSP ��λ�� executor ����֮��;�Ự�������ڶ���������(spawn+initialize+didOpen һ���� setup);**�汾ӳ�䲻����**:LSP textDocument.version == ENCA revision;**�ύ�ʸ�����Ž�**:document_id �� generation �� revision �� ?cancelled����������ȷ�Ի���,`$/cancelRequest` ֻ���Ż��㡣

### 21.2 ���۹���(B0/B1/B2)
| �� | ·�� | round trip |
|---|---|---|
| B0 synthetic | ֱ�Ӻ������� | ~2��s |
| **B1 loopback**(JSON-RPC + ��ʵ OS �ܵ�) | ���л� 2.5��s + ���� 6.7��s + �ں˹ܵ� | **avg 8.12��s**(p_max 60��s,K=200) |
| B2 clangd | ͬ B1 + ��ʵ������ | **p50 = 77ms**(p95=108ms;setup: spawn+initialize 83ms,didOpen 1MB=8ms) |

```
B1 ? B0 �� �� ��s   �� JSON-RPC + IPC ����
B2 ? B1 �� 77ms    �� clangd ����,ռ candidate-ready �� >99%
```

### 21.3 �ж�:�����������ͬʱ����
- **GO-Transport**:����ռ�� ~0.01% �� JSON/IPC ��ʽ�ж�Ϊ��ƿ��,**simd-json / shared-memory / ���� IPC �������������÷�֤**(���Ǹ�����״�ı䲢����֤��);
- **GO-Backend**:clangd ���� >50% �� ��һ���� backend/context ������ Completion UI ����(EVS-4.4)��

ԭʼ�۵�ĳ�ʵ����:**Dynamic Module ���� Emacs?ENCA �߽� JSON ����������ʵ��(��s ��),���ִ� IDE �ӳٲ�಻������߽��ϡ������� backend �� UI��**

### 21.4 ���̼�¼
- ��д��С JSON-RPC codec(�ݹ��½���Ա����,�ַ������ݸ�֪);�޸�������ʵȱ��:(a) ��ƥ�����ֵ��� `{"a":1,"id":42}`��1;(b) ֡���Ѻ� acc δ���õ��¾�֡�ط�;(c) loopback �������ſ�(discipline:֪ͨҲ��������Լ��Ļ���);
- Windows �ܵ��ȴ����á����� 2ms + Sleep(1) ���ס���ϲ���,B1 ���򱣳�΢��ֱ���;
- ȫ�׼� **31978 checks / 0 failures**(storm-real ���� 31995/0),ASan �ɾ���

### 21.5 ��һ��
EVS-4.4:commit �� candidate ת�� �� completion-table �� popup �� redisplay �� visible ����ι��򡣰� ��5 GO-UI ����,�� commit��visible ����β���ӳ�,��ս����ʽת�Ƶ� Emacs UI/redisplay��



## 22. EVS-4.4 Closure �� UI Critical Path Attribution(2026-08-24)

### 22.1 ��Լ(`bench/enca/evs4/UI_ATTRIBUTION.md`)
T0�CT12 ʱ��㡢�ı�(A0 synthetic / A1 real / A2 worker-built model / A3 worker-built popup model)��R ����(R0�CR4)���Լ�**Ԥ����� Render Snapshot ��״**(worker �����ɱ����,���߳� validate��swap��damage��redisplay)������δ����֧ B ����ʱֱ��ʹ��,���������Ʊ��ۡ�

### 22.2 Completion transformation(T6��T7,��ʵ Emacs ���ݽṹ)
| ��ѡ�� | all-completions p50 |
|---|---|
...
### 22.3 Redisplay ����(tty,ǿ���ػ�,���ն����)
| �� | p50 |
|---|---|
| R0 �޵������� | 0.033ms |
| R2 popup overlay(1/10/50 ��)| **1.57�C2.04ms** |

popup redisplay ��Ի��� ~60��,������ֵ�� ~2ms��

### 22.4 �ж�
- **��֧ B(redisplay �ع�)������**:2ms ����ֵԶ�����κ��ع�֤���ż�;EVS-5 Render Snapshot **�޾�����,�ر�**;
- ��֧ A ���ڲ�̬ 100K ��ѡ������;
- candidate-ready��visible �� **~2ms(tty)**,GUI �ỰԤ�Ƹ���;
- keypress��visible ������������ **clangd ��� 78�C92ms**(��21)����ENCA ȫ��·(capture+snapshot+scheduler+wakeup+transport)�ϼ� <0.1ms��

### 22.5 ��Ŀ������(֤�����պ�)
�ִ� IDE ��಻�� Emacs �߽硢���� JSON/IPC������ snapshot/scheduler/runtime,���� (1) LSP backend ������ (2) ��ʵ completion UI �ļ���������ENCA �Ѱѡ�Emacs �����ɿصĲ��֡�ѹ��΢��~�Ǻ��뼶��ȫ������;�����κ��Ż��������� keypress��visible ��ָ������뼶����,��������



## 23. Project Re-scope �� ENCA Performance Freeze �� EVS-5(2026-08-24)

�����о��ջ����:keypress��visible �������ֽ��Ѿ�����,**ENCA runtime <0.1ms��completion UI ~2ms��LSP backend 78�C92ms(����)**���ݴ�:

- **ENCA Performance Freeze** ��Ч(`src/enca/ARCHITECTURE.md` ��26):P1/P2/P3/EVS-1..4 ȫ�� CLOSED,EVS-5 Render Snapshot NO-GO;���߳� UI��redisplay �ع������� GC��allocator �滻��NUMA��work stealing��shared-memory LSP��SIMD JSON��Rust �� core ȫ������;
- **��߹�������**:��û�к��뼶 user-path attribution,��û�мܹ��Ķ�����������ÿһ��رն��ɸù������,�ؿ��κ�һ����Ҫ��ʵ��ָ�����������ľ�ȷ����ݶ�;
- ��Ŀ��ʽ����Ϊ **ENCA Real Completion / Semantic Latency**,��һ�׶�ΨһĿ��:�� 78�C92ms �� backend �����������������������о�����:**D1 Backend Context Engineering��D2 Cancellation/Speculation��D3 Completion Cache**;
- EVS-5.0 ��Լ�Ѷ���(`bench/enca/evs5/EVS5.md`):C1�CC10 ʵ�����(cold/warm/narrowing/storm/cursor/edit/cancel/hit/miss/large-project)������������Լ(���ɱ� refcounted ��Ŀ + ����ʧЧ)���׶��Ž� 5.0��5.5����ָʾ,���׶β�д���롣



## 24. P0 Baseline Closure �� Vanilla / ENCA-disabled / ENCA-enabled(2026-08-24)

### 24.1 ��·����(ͬһ upstream ���� `11a1cb7445d`,ͬ configure��ͬ CFLAGS=-O2)

| ���� | ���� | ��֤ |
|---|---|---|
| A vanilla | upstream Դ�뵼��,�� ENCA ���� | config.h �� HAVE_ENCA |
| B disabled | fork ȫ��Դ��,`configure`(Ĭ�Ϲ�)| **ENCA_OBJ Ϊ��**;emacs �� A �ֽڴ�Сһ��(2992936)|
| C enabled | fork ȫ��Դ��,`--enable-enca` | ENCA_OBJ ��ȫ�� enca ���� |

### 24.2 Batch �׼�(��λ�� ms,��3 �� ��7 reps)
| cell | A | B | C | B/A | C/B |
|---|---|---|---|---|---|
...
### 24.3 tty Redisplay �׼�(pty ǿ���ػ�,��3 �� ��10 reps)
| cell | A | B | C | B/A | C/B |
|---|---|---|---|---|---|
...
```text
A �� B  ��  ENCA patch �� Emacs baseline �޿ɲ�����ɱ�
       (disabled ������ vanilla �ֽڼ�ͬ�ߴ硢��Ϊͬ��)
B �� C  ��  ENCA runtime ���ò�����ϵͳ�Իع�
A �� C  ��  �û��ɼ�·�������޻ع�
```

**ENCA ��ʽ���������������ų���** ��� ��18�C��22:completion ·�����ӳ����������ⲿ LSP backend(~80ms),���� Emacs ���ġ���� ENCA��EVS-5(Real Completion / Semantic Latency)��˾۽� backend/context/cache ����ľ��߻���������ݡ�

### 24.5 �����޸�
`src/enca/lsp/transport.c` POSIX ��֧�������� `\n` ��Ⱦ(��ǰ PowerShell �滻�¹�,Windows �������ɼ�)�������� WSL ������¶���޸���



## 25. EVS-5.2.6 Closure �� Cache ������ʵ UI:keypress��visible ����(2026-08-24)

### 25.1 ����
`enca-evs-complete PREFIX CURSOR` ����ʵ tty Emacs ���������û�·��:capture/snapshot �� scheduler(INTERACTIVE)�� worker(cache lookup �� miss ʱ LSP ����)�� wakeup �� ��ѡ �� popup overlay ��װ �� ǿ�� redisplay��MISS �ۺ�˳ɱ��� 90ms loopback ע��ģ��(clangd ʵ�� 78�C92ms,EVS-4.3);���������Ϊ��ʵ���롣

### 25.2 keypress��visible(tty,ÿ op �� popup+redisplay)
| �� | ops | hit% | **p50** | max |
|---|---|---|---|---|
| HIT(�ظ�ǰ׺)| 20 | 100% | **0.58ms** | 2.0ms |
| MISS(+90ms ���)| 12 | 0% | 90.4ms | 90.6ms |
| MIX(����)| 16 | 50% | 90.3ms | 90.5ms |

engine �ڲ�(hit ·��)��0.001ms;UI ��(popup+redisplay)��0.3�C0.6ms������ EVS-4.4 �� ~2ms tty �ذ�ͬ�����Ҹ���(���� popup)��

### 25.3 �ж�
**C8c/C12 ���**:hit ���������� keypress��visible <1ms;C11 �ṹ�Գ���(hit ·�����˽Ӵ�)����Ŀ��һ�γ���**�������������û��ɸ�֪����**(90ms �� 0.58ms)��

��ʵ�߽�:novel-prefix miss ���� backend-bound(~90ms)�����������ִ� IDE ����̬(���м�ʱ��δ���еȴ�������)�������������� EVS-5.2 Stage D(cross-revision reuse,�������Լ)����ʵ�������о���

### 25.4 �����޸�
- didChange JSON ȱ������(EVS-4.3 storm-real ������˻��ڳ¾��ĵ�,��ע��);
- collect/round_trip ������ publishDiagnostics ֪ͨ֡;
- spawn ֧�ֶ��� argv(exec_argv),fake server �ı�׼ LSP ��ͷ��ȡ(ԭ bulk read ��С֡����);
- һ�� getenv-vs-emacs-environ �����δ���(ԭ����Ӳ����Ĭ��ֵ�ƿ�,gdb ��λ)��



## 26. EVS-5.3 Closure �� Real Typing Workload(F1,2026-08-24)

### 26.1 ��������(tty Emacs + loopback ���,miss ע�� 90ms ˼��ʱ��)
| ���� | ops | exact | extend | miss | backend avoided | p50 |
|---|---|---|---|---|---|---|
| identifier-growth(���ַ����)| 32 | 9 | 2 | 21 | **34.4%** | 90.3ms(miss ����)|
| retry(ͬ��������)| 10 | 10 | 0 | 0 | **100%** | **0.074ms** |
| edit-interleaved(�༭����)| 12 | 0 | 0 | 12 | 0% | 90.4ms |

Stage-B(ͬ revision �� prefix ��������)��غ�,�����࿪ʼ���� extend ����;����ʧЧ�����±༭�����ఴ���ȫ�� miss����**�������б���**��

### 26.2 F2 �Ž�����(��9.5)
identifier+retry ���ѽ����Ǻ���;ʣ�� backend-bound ������**�༭��������ȫ**�����̡�cross-revision reuse �Ŀ�֤������Ŀ�� = �� edit-interleaved �� 0% ������ >50% �� false_hit=0����Ŀ����ȷ��ʵ�ַ��ո�(��Ҫ unrelatedness proof rule)����**F2 ά�ֹر�**,�ȴ���ʵ�û�������ʾ�ó���ռ������֤���临�Ӷȡ�
...
```
��Ŀ��"�ܹ��Ż�"����ת��Ϊ"�����ӳ�ʵ��ƽ̨":ÿһ��ĳɱ���ÿһ���ܸ˵���Ч�ԡ�ÿһ���߽�,���пɸ���ʵ����ԭʼ����֧�š�
